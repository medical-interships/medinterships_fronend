...
import { Building, Users, FileText, Mail, User, Upload, AlertCircle } from "lucide-react"
...
export default function ChiefProfilePage() {
  const [formData, setFormData] = useState({
    first_name: "Karim",
    last_name: "Belkacem",
    email: "k.belkacem@chu-alger.dz",
    phone: "+213 23 456 789",
    establishment: "CHU Béni Messous",
    service: "Cardiologie",
  })
  const [bio, setBio] = useState("Chef de service de cardiologie depuis 2018.")
  ...
  useEffect(() => {
    ...
    const totalFields = 8 // 7 champs + avatar
  ...
  const stats = [
    { label: "Service gérés", value: "1", icon: Building },
    { label: "Stages ouverts", value: "4", icon: FileText },
    { label: "Étudiants encadrés", value: "28", icon: Users },
  ]

  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        <h2 className="text-3xl font-bold text-foreground mb-2">Mon Profil Chef de service</h2>
        <p className="text-muted-foreground">Gérez vos informations et votre service</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Votre parcours professionnel..."
                />
              </div>
        ...
        <div className="space-y-6">
          <Card className="p-6 border-border/50 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Chef – {formData.service}</p>
