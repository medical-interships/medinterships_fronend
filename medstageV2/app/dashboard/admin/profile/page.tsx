...
import { Shield, Users, Building, Mail, Upload, AlertCircle } from "lucide-react"
...
export default function AdminProfilePage() {
  ...
  const [bio, setBio] = useState("Administrateur principal de la plateforme de stages médicaux.")
  const [permissions] = useState(["users.manage", "establishments.edit", "system.logs", "notifications.send"])
  ...
  useEffect(() => {
    ...
    const totalFields = 6 // 5 champs + avatar
  ...
  const stats = [
    { label: "Établissements", value: "24", icon: Building },
    { label: "Utilisateurs", value: "1,210", icon: Users },
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        <h2 className="text-3xl font-bold text-foreground mb-2">Mon Profil Administrateur</h2>
        <p className="text-muted-foreground">Gérez votre compte et les permissions système</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <Card className="p-6 border-border/50">
            <h3 className="text-lg font-semibold text-foreground mb-6">Informations du Compte</h3>
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="À propos de votre rôle..."
                />
              </div>
        ...
        <div className="space-y-6">
          <Card className="p-6 border-border/50 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Administrateur</p>
